...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/add_book.css">
...
<body>
    ...
    <div class="main">
        <div class="col-1">
            <h5>Add books to library system</h5>
        </div>
        <div class="col-2">
        ...
        <div class="col-3">
            <form name="formAddBooks" onsubmit="return checkAddBooks(), return filename() " action="<?php echo base_url("Post/add_book")?>" method="POST"  enctype="multipart/form-data">
                ...
                <div class="group-1">
                    ...
                    <div class="div-input">
                        <p>Available</p>
                        <input type="Number" name="avilable" id="avilable" placeholder="0">
                    </div>
                </div>
    ...
    <?php
        if($this->session->flashdata('data-saved')) {	?>
        <div class="data_saved_class" id="data_saved_class">
            <div class="container">
                <p class="text-danger text-center" id="warning-check-book" style="font-size:12px; color:Green;"><?=$this->session->flashdata('data-saved')?></p>
            </div>
        </div>
    <?php } ?>
    ...
    <script>
        ...
        // Function to hide the div after 5 seconds
            setTimeout(function() {
                const div = document.getElementById('data_saved_class');
                if (div) {
