...
<body>
    ...
    <div class="main">
        <div class="col-1">
            <h5>Archive books to library system</h5>
            <div class="search">
            ...
            <?php if (!empty($results)): ?>
                <table>
                    ...
                    <?php foreach($results as $rows):?>
                        <tr>
                            <td><a id="delete" href="<?php echo base_url("Auth/getBookToArchieve/$rows->ID");?>"><i class="fa-solid fa-trash-can"></i></a></td>
                            ...
                            <td><?php echo $rows->sourceoffund; ?></td>
    ...
    <?php if(isset($toDelete)):?>
        <div class="confirmation_class">
            <div class="confirmation_container">
                <div class="close_btn">
                    <h6>Do you really want to Archive Book?</h6>
                    ...
                    <div class="confirmation_content">
                        <div class="book-info3">
                            ...
                            <div class="confirm_btn">
                                <a href="<?php echo base_url("Post/archieve_book/$row->ID");?>" class="button">Confirm</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach;?>
