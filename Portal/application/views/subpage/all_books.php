...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/all_books.css">
    <script src="<?php echo base_url(); ?>Portal/assets/javascript/convertToPesoFormat.js"></script>
...
<body style="background-image: url(<?php echo base_url('assets/image/bg-image-library.png') ?>);" onload="convertToPeso()">
    ...
    <div class="body">
        ...
        <div class="main">
            <div class="search">
                <form action="<?php echo site_url('post/search'); ?>" method="get">
                ...
                <?php if (!empty($results)): ?>
                    <?php foreach($results as $row):?>
                        <?php foreach($data as $rows):?>
                            <a href="<?php echo base_url("Auth/view_book_all_books/$row->ID/$rows->Student_ID")?>">
                        <?php endforeach; ?>
